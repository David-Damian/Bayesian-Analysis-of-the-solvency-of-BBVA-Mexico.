...
predicciones_estatico_train |> ggplot(aes(x = fecha, y = TDC_train)) +
  geom_line(col = "black") +
  geom_line(aes(x=fecha, y = lower), linetype='dashed' , color = "blue") +
  geom_line(aes(x=fecha, y = upper), linetype='dashed' , color = "blue") +  
  geom_line(aes(x = fecha, y = est.puntual),color = "salmon") + # serie inferida test
  geom_line(data= predicciones_estatico_test|> slice(1:12), aes(x=fecha, y=TDC), color='black') +
  geom_line(data= predicciones_estatico_test|> slice(1:12), aes(x=fecha, y = lower), linetype='dashed' , color = "blue") +
  geom_line(data= predicciones_estatico_test|> slice(1:12) , aes(x=fecha, y = upper), linetype='dashed' , color = "blue") +  
  geom_line(data= predicciones_estatico_test|> slice(1:12), aes(x = fecha, y = est.puntual),color = "cyan2") +
  ylab('TDC') +
  xlab('Fecha') +
  theme_bw() +
  sin_lineas 
...
El ajuste para este modelo se presenta a continuación.
...
predicciones_estatico2_train |> ggplot(aes(x = fecha, y = TDC_train)) +
  ...
  geom_line(aes(x=fecha, y = lower), linetype='dashed' , color = "blue") +
  geom_line(aes(x=fecha, y = upper), linetype='dashed' , color = "blue") +  
  geom_line(aes(x = fecha, y = est.puntual),color = "salmon") + # serie inferida
  geom_line(data= predicciones_estatico2_test|> slice(1:12), aes(x=fecha, y=TDC), color='black') +
  geom_line(data= predicciones_estatico2_test|> slice(1:12), aes(x=fecha, y = lower), linetype='dashed' , color = "blue") +
  geom_line(data= predicciones_estatico2_test|> slice(1:12) , aes(x=fecha, y = upper), linetype='dashed' , color = "blue") +  
  geom_line(data= predicciones_estatico2_test|> slice(1:12), aes(x = fecha, y = est.puntual),color = "cyan2") +
  ylab('TDC') +
  xlab('Fecha') +
  theme_bw() +
  sin_lineas 
...
predicciones_dinamico_train |> ggplot(aes(x = fecha, y = TDC_train)) +
  ...
  geom_line(aes(x=fecha, y = upper), linetype='dashed' , color = "blue") +  
  geom_line(aes(x = fecha, y = est.puntual),color = "salmon") + # serie inferida
  geom_line(data= predicciones_dinamico_test|> slice(1:12), aes(x=fecha, y=TDC), color='black') +
  geom_line(data= predicciones_dinamico_test|> slice(1:12), aes(x=fecha, y = lower), linetype='dashed' , color = "blue") +
  geom_line(data= predicciones_dinamico_test|> slice(1:12) , aes(x=fecha, y = upper), linetype='dashed' , color = "blue") +  
  geom_line(data= predicciones_dinamico_test|> slice(1:12), aes(x = fecha, y = est.puntual),color = "cyan2") +
  ylab('TDC') +
  xlab('Fecha') +
  theme_bw() +
  sin_lineas 
...
predicciones_dinamico_train |> ggplot(aes(x = fecha, y = TDC_train)) +
  ...
  geom_line(aes(x=fecha, y = lower), linetype='dashed' , color = "blue") +
  geom_line(aes(x=fecha, y = upper), linetype='dashed' , color = "blue") +  
  geom_line(aes(x = fecha, y = est.puntual),color = "salmon") + # serie inferida en test
  geom_line(data= predicciones_dinamico_test|> slice(1:12), aes(x=fecha, y=TDC), color='black') +
  geom_line(data= predicciones_dinamico_test|> slice(1:12), aes(x=fecha, y = lower), linetype='dashed' , color = "blue") +
  geom_line(data= predicciones_dinamico_test|> slice(1:12) , aes(x=fecha, y = upper), linetype='dashed' , color = "blue") +  
  geom_line(data= predicciones_dinamico_test|> slice(1:12), aes(x = fecha, y = est.puntual),color = "black") +
  geom_line(data= predicciones_dinamico_test|> slice(13:67), aes(x = fecha, y = est.puntual), linetype='dashed',color = "cyan2") + # PROYECCIÓN
  geom_line(data= predicciones_dinamico_test|> slice(13:67), aes(x=fecha, y = lower), linetype='dashed' , col = "blue") +
  geom_line(data= predicciones_dinamico_test|> slice(13:67) , aes(x=fecha, y = upper), linetype='dashed' , color = "blue") +  
  ylab('TDC') +
  xlab('Fecha') +
  theme_bw() +
  sin_lineas 
